...
let girl, boy, abe, cactus, volleyball;

function preload() {
  girl = loadImage('/images/unicycle_girl.png');
  boy = loadImage('/images/unicycle_boy.png');
  //abe = loadImage('/images/abraham_small.png');
  volleyball = loadImage('/images/volleyball.png');
  cactus = loadImage('/images/cactus.png');
  rr = loadImage('/images/roadrunnereuc.png');
}
...
function setup() {
  ...
  */
  ...
  game.fence = new Wall(0, 0.75 + ref_wallheight+2, ww, (ref_wallheight-1.5+4.5));
...
function draw() {
  ...
  if (sunY < height+sunRad) {
    ...
    for (var i=0; i<5; i++) {
      ...
      ellipse(width-240 , sunY, sunRad-i*5, sunRad-i*5);
    }
    pop();
  }
...
// road runneer
image(rr, -200+(6*frameCount)%(width+8*width), height-300, 250, 250);
